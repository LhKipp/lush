...
use crate::{
    ast::{self, support, AstElement, AstNode, AstToken},
    SyntaxElement,
    SyntaxKind::{self, *},
...
impl AstElement for ExpressionNode {
    fn can_cast(kind: SyntaxKind) -> bool {
        match kind {
            BareWord | Number | MathExpr | StringExpr | ValuePathExpr | ArrayExpr | TableExpr => {
                true
            }
            _ => false,
        }
    ...
    fn cast(syntax: SyntaxElement) -> Option<Self> {
        let res = match syntax.kind() {
            BareWord => ExpressionNode::BareWord(BareWordToken {
                syntax: syntax.into_token().unwrap(),
            }),
            Number => ExpressionNode::Number(NumberToken {
                syntax: syntax.into_token().unwrap(),
            }),
            MathExpr => ExpressionNode::MathExpr(MathExprNode {
                syntax: syntax.into_node().unwrap(),
            }),
            StringExpr => ExpressionNode::StringExpr(StringExprNode {
                syntax: syntax.into_node().unwrap(),
            }),
            ValuePathExpr => ExpressionNode::ValuePathExpr(ValuePathExprNode {
                syntax: syntax.into_node().unwrap(),
            }),
            ArrayExpr => ExpressionNode::ArrayExpr(ArrayExprNode {
                syntax: syntax.into_node().unwrap(),
            }),
            TableExpr => ExpressionNode::TableExpr(TableExprNode {
                syntax: syntax.into_node().unwrap(),
            }),
            _ => return None,
        };
